...
/*
Pure virtual function- A function for which we do not have an implementation. We do not Wrtie any functionality in it, we only declare this function.
...
Classes derived from abstract classes need to impliment the pure virtual function.
